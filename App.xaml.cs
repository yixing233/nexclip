    ...
    protected override void OnLaunched(LaunchActivatedEventArgs args)
    {
        ...
        if (Services.Settings.AutoCheckUpdate)
        {
            _ = Task.Run(async () =>
            {
                ...
                try
                {
                    var rawVersion = (System.Attribute.GetCustomAttribute(typeof(App).Assembly, typeof(System.Reflection.AssemblyInformationalVersionAttribute)) as System.Reflection.AssemblyInformationalVersionAttribute)?.InformationalVersion?.Split('+')[0] ?? "20260825.02";
